...
Дашборды и интерфейсы: https://hackathon2-jduazbyzxd49yeqftasas8.streamlit.app/
Карточка проекта: https://teal-azure-78455542.figma.site
Презентация: https://prism-gentle-85799314.figma.site
...
* **Канаев Артем** — руководитель проекта, ML инженер (churn prediction, рекомендации)
* **Панченко Наташа** — аналитика, визуализация, подготовка дашбордов
* **Щигарев Дмитрий** — анализ воронки, события, трафик
* **Исламов Сардор** — анализ маржинальности, кластеризация пользователей
* **Шилов Виктор** — анализ корреляции возвратов и сроков доставки
